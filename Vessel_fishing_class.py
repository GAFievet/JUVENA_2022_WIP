...
class Vessel_fishing:
	def __init__(self, loc_i, loc_f, time_stamp, species, mass_fished):
		"""
	...
	def abundance_pie_chart(self, a):
		...
		"""
		slices, labels, percentages = a.pie(self.mass_fished, labels = self.species, autopct = '%1.1f%%', startangle =
		140)
		a.axis('equal')
