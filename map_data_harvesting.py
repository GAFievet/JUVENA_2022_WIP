...
# Add a label
ax.text(-2.92337 + lon_offset, 43.25694, 'Bilbao', transform = ccrs.Geodetic(), fontsize = 10,
        horizontalalignment = 'left',
        verticalalignment = 'top')
# Plot Pasaia on the map
ax.plot(-1.92114, 43.32531, 'ko', markersize = 6, transform = ccrs.Geodetic())
# Add a label
ax.text(-1.92114 + lon_offset, 43.32531, 'Pasaia', transform = ccrs.Geodetic(), fontsize = 10,
        horizontalalignment = 'left',
        verticalalignment = 'top')
